...
function previewFile() {
    ...
    if (file) {
        ...
        $("#text_profile_inst").css("top","506px");
    } else {
        preview.src = "";
        $("#text_profile_inst").css("top","306px");
    }
}
...
function specType(content){
    ...
    setTimeout(function(){
      shouldstop = false;
      autoType(".type-js",20,".pop_inst1", content);
    }, 50)
}
  ...
  $('#otp_inst').focus(function(){
    // specificType(".pop_signup2","#pop_sign2");
    specType("Enter the OTP recieved at your email");
  })

  $('#passcode_inst').focus(function(){
    // specificType(".pop_signup2","#pop_sign2");
    specType("Passcode should contain atleast 8 characters. Use mixture of numbers, symbols and alphabets of both cases");
  })
